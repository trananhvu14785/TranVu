        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            try
            {
                if(dem == 1)
                {
                    ...
                    if (tbMaNcc.text == "" || tbTenNcc.text == "" || tbDiaChi.text == "" || tbSdt.text == "")
                    {
                        Alert a = new Alert("Vui lòng nhập đủ thông tin!", AlertType.info);
                        a.ShowDialog();
                    }
                    else if (kiemTra(maNcc) == true)
                    {
                        Alert a = new Alert("Mã nhà cung cấp đã tồn tại!", AlertType.error);
                        a.ShowDialog();
                ...
                else if(dem == 2)
                {
                    ...
                    else if (tbMaNcc.text == "" || tbTenNcc.text == "" || tbDiaChi.text == "" || tbSdt.text == "")
                    {
