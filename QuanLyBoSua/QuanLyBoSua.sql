...
update account set maNv='admin' where tenDn='admin'
...
insert into CTHDNhapBo values('7','DB033','18000000')
select * from DanBo
...
select * from CTHDNhapBo where maHD='10'
select * from DanBo
select d.maBo,d.gioiTinh,d.trongLuong, d.idCategory,cth.giaBoNhap,cth.LoaiNhap,d.MaChuong,cth.LoaiNhap
                     from HdNhapBo H,DanBo d, CTHDNhapBo cth,categoryBo C
                     where H.maHD = cth.maHD and d.maBo = cth.maBo and  C.idCategory=d.idCategory and cth.maHd='10' 
